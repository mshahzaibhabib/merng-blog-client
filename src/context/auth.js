...
if (localStorage.getItem("jwtToken")) {
    // this token stores an expiration date and time and we dont want to set our app to be logged in
    // if this one hour long token has expired, so we need to check whether it is expired or not but 
    // this expiration is actually encoded inside of the token so we need to decode it.
...
// Now we need to use this reducer and we will do in auth provider
